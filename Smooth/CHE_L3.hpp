...
public:
  ...
  CHE_L3(): CHE_L2(), _ncurves(0){ _CH.clear(); }

  /** \brief First constructor.
    * \param nvert  - Vid  CHE_L0 _nvert.
    * \param ntrig  - TRid CHE_L0 _ntrig.*/
  CHE_L3(Vid nvert, TRid ntrig): CHE_L2(nvert, ntrig), _ncurves(0){ _CH.clear(); }

  /** \brief Copy constructor
    * \param c - const CHE_L3&.*/
  CHE_L3(const CHE_L3& c): CHE_L2( c ),_ncurves(0) { _CH= c._CH; }
